...
while(true)
{
	...
	a = a + input[i++ % input.length]
  // check if frequency in our dictionary
	if (d[a] == null)
	{
		d[a] = 0
	} else {
...
console.log("Day 2 Part B - First Duplicate Frequency = " + a)
