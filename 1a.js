...
console.log("Day 1 Part A - Resulting Frequency = " + total);
...
console.log("Time2 = " + ((Date.now() - time) / 1000) + " seconds");
...
if ( a3.indexOf(c2) === -1 ) {
    ...
    console.log("Day 2 Part B - First Duplicate Frequency = " + c2);
	console.log("Array Position = " + i2);
	i2 = a2.length;
}
	i2++;
}
